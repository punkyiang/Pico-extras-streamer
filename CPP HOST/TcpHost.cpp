...
private:
    void HandleClient() {
        ...
        while (true) {
            ...
            if (msg.etData.leftEyeMiddleCanthusUvX == 0
                && msg.etData.leftEyeMiddleCanthusUvY == 0
                && msg.etData.leftEyeOpenness == 0
                && msg.etData.leftEyePupilDilation == 0

                && msg.etData.rightEyeMiddleCanthusUvX == 0
                && msg.etData.rightEyeMiddleCanthusUvY == 0
                && msg.etData.rightEyeOpenness == 0
                && msg.etData.rightEyePupilDilation == 0) 
                continue;
